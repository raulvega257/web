...
//     if (!extent[0] || !extent[1]) return; // Evita continuar si los valores no son válidos
...
//       if (yMax === undefined) return; // o usa un valor por defecto si prefieres
...
//     const svgRef = useRef<SVGSVGElement | null>(null);
//     type DataPoint = { date: Date; marketCap: number; signal: number };
...
//           signalsGroup.selectAll("circle")
//           .attr("cx", d => newX((d as DataPoint).date));
...
//       svg.call(zoom); // Ya es compatible al garantizar que svgRef.current no es null
    
//     }, [xScale, xAxis, line, path, signalsGroup, tooltipPointsGroup, xAxisGroup, yearLinesGroup]);
...
//   const svgRef = useRef<SVGSVGElement | null>(null);
//   const yAxisRef = useRef<SVGSVGElement | null>(null);
//   const tooltipRef = useRef<HTMLDivElement | null>(null); // Cambiado a HTMLDivElement
//   const wrapperRef = useRef<HTMLDivElement | null>(null); // Cambiado a HTMLDivElement
