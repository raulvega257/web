...
//   const [selectedSet, setSelectedSet] = useState('precio');
...
//       const rawData = result.Data.Data.map((entry: any) => ({
//         ...entry,
//         formattedDate: dayjs.unix(entry.time).format('DD/MM/YYYY'),
//         coinValue: entry.close,
//       }));
...
//       const precio = rawData.map(({ formattedDate, coinValue }) => ({ formattedDate, coinValue }));
//       const cierre = rawData.map(({ formattedDate, close }) => ({ formattedDate, close }));
//       const apertura = rawData.map(({ formattedDate, open }) => ({ formattedDate, open }));
//       const minimo = rawData.map(({ formattedDate, low }) => ({ formattedDate, low }));
//       const maximo = rawData.map(({ formattedDate, high }) => ({ formattedDate, high }));
//       const aperturaCierre = rawData.map(({ formattedDate, open, close }) => ({ formattedDate, open, close }));
//       const minimoMaximo = rawData.map(({ formattedDate, low, high }) => ({ formattedDate, low, high }));
//       const todo = rawData.map(({ formattedDate, open, close, low, high }) => ({ formattedDate, open, close, low, high }));
...
//     if (range === '365') return data.slice(-365);
//     return data;
//   };
...
//     { key: 'aperturaCierre', label: 'Apertura vs Cierre' },
//     { key: 'minimoMaximo', label: 'Mínimo vs Máximo' },
//     { key: 'todo', label: 'Todo' },
//   ];
...
//             <button
//               className="w-full text-left text-white font-semibold focus:outline-none mb-2"
//               onClick={() => setShowAccordion(!showAccordion)}
//             >
//               {showAccordion ? '▼' : '▶'} Comparar monedas
//             </button>
//             {showAccordion && (
//               <div className="space-y-4">
//                 <div>
//                   <p className="text-sm text-gray-300 mb-1">Criptomoneda:</p>

//                   {monedasCripto.map(({ key, label }) => (
//                     <button
//                       key={key}
//                       onClick={() => setCrypto(key)}
//                       className={`w-full text-left px-4 py-2 rounded transition
//                         ${crypto === key ? 'bg-indigo-700 text-white' : 'bg-gray-700 text-gray-300'}
//                       `}
//                     >
//                       {label}
//                     </button>
...
//                 </div>
//                 <div>
//                   <p className="text-sm text-gray-300 mb-1">Moneda Fiat:</p>
//                   {monedasFiat.map(({ key, label }) => (
//                     <button
//                       key={key}
//                       onClick={() => setFiat(key)}
//                       className={`w-full text-left px-4 py-2 rounded transition
//                         ${fiat === key ? 'bg-indigo-700 text-white' : 'bg-gray-700 text-gray-300'}
//                       `}
//                     >
//                       {label}
//                     </button>
...
//           {/* Acordeón de sets */}
//           <div className="bg-gray-800 rounded-xl p-4">
//             <h3 className="font-semibold text-white mb-2">Seleccionar set de datos</h3>
//             {opciones.map(({ key, label }) => (
//               <button
//                 key={key}
//                 onClick={() => setSelectedSet(key)}
//                 disabled={!dataSets[key].length}
//                 className={`block w-full text-left px-4 py-2 rounded hover:bg-indigo-600 transition
//                   ${selectedSet === key ? 'bg-indigo-700 text-white' : 'bg-gray-700 text-gray-300'}
//                   ${!dataSets[key].length && 'opacity-50 cursor-not-allowed'}
//                 `}
//               >
//                 {label}
//               </button>
...
//           {/* Filtro de rango */}
//           <div className="bg-gray-800 rounded-xl p-4">
//             <h3 className="font-semibold text-white mb-2">Seleccionar rango de tiempo</h3>
//             {[{ key: '30', label: 'Últimos 30 días' }, { key: '365', label: 'Últimos 365 días' }, { key: 'all', label: 'Todos los datos' }]
//               .map(({ key, label }) => (
//                 <button
//                   key={key}
//                   onClick={() => setRange(key as '30' | '365' | 'all')}
//                   className={`block w-full text-left px-4 py-2 rounded hover:bg-indigo-600 transition
//                     ${range === key ? 'bg-indigo-700 text-white' : 'bg-gray-700 text-gray-300'}
//                   `}
//                 >
//                   {label}
//                 </button>
...
//         {/* Gráficaaaaaaaaaaaaaaaaaaaaaaaa loca */}
//         <div className="col-span-4 order-2 md:order-1 border-4 border-indigo-100">
...
//             <h2 className="text-xl font-semibold mb-4 text-gray-200">
//               {opciones.find((opt) => opt.key === selectedSet)?.label} ({rangoLabel[range]})
//             </h2>
...
//           {/* Acordeón de selección de monedas */}
//           <div className="space-y-4">
...
//               <details
//                 ref={cryptoRef}
//                 className="group open:ring-2 open:ring-indigo-500 transition-all"
//               >
...
//               >
//                 <summary className="cursor-pointer font-semibold text-white flex justify-between items-center">
//                   <span>Seleccionar moneda fiat</span>
//                   <span className="transition-transform duration-300 group-open:rotate-90">▶</span>
//                 </summary>
//                 <div className="mt-4">
//                   <select
...
//   const cryptoRef = useRef<HTMLDetailsElement>(null);
//   const fiatRef = useRef<HTMLDetailsElement>(null);
//   const dataSetRef = useRef<HTMLDetailsElement>(null);
...
//       setDataSets({ precio, cierre, apertura, minimo, maximo, aperturaCierre, minimoMaximo, todo });
//     } catch (error) {
//       console.error('Error al obtener los datos:', error);
//     }
//   };
...
//             {/* Moneda Fiat */}
//             <div className="bg-gray-800 rounded-xl shadow-inner p-4 text-gray-400">
//               <details ref={fiatRef} className="group open:ring-2 open:ring-indigo-500 transition-all">
//                 <summary className="cursor-pointer font-semibold text-white flex justify-between items-center">
//                   <span>Seleccionar moneda fiat</span>
//                   <span className="transition-transform duration-300 group-open:rotate-90">▶</span>
//                 </summary>
...
//             {/* Set de datos */}
//             <div className="bg-gray-800 rounded-xl shadow-inner p-4 text-gray-400">
//               <details ref={dataSetRef} className="group open:ring-2 open:ring-indigo-500 transition-all">
//                 <summary className="cursor-pointer font-semibold text-white flex justify-between items-center">
//                   <span>Seleccionar set de datos</span>
//                   <span className="transition-transform duration-300 group-open:rotate-90">▶</span>
//                 </summary>
//                 <div className="mt-4">
//                   <select
...
//                       setTimeout(() => dataSetRef.current?.removeAttribute('open'), 100);
//                     }}
//                   >
//                     {opciones.map(({ key, label }) => (
//                       <option
...
//                 <summary className="cursor-pointer font-semibold text-white flex justify-between items-center">
//                   <span>Seleccionar rango de tiempo</span>
//                   <span className="transition-transform duration-300 group-open:rotate-90">▶</span>
//                 </summary>
//                 <div className="mt-4">
//                   <select
...
//       const todo = rawData.map(({ formattedDate, open, close, low, high }) => ({
//         formattedDate,
//         open,
//         close,
//         low,
